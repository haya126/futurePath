...
st.markdown("""
    <style>
        ...
        * { font-family: 'Tajawal', sans-serif !important; }
        ...
        /* College card text aligned left */
        .college-card { border-right: 6px solid #003366; padding: 20px 25px; margin: 20px 0; background-color: #f9f9f9; border-radius: 10px; text-align: left; }
